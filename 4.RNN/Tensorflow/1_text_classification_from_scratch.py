...
Original file is located at
    https://colab.research.google.com/drive/1ULbASfC7ojKs92k51w0pIoED-okE0qf3
...
#Looking at some Sample Examples
...
#We add Vanilla hidden layer
x =  layers.Dense(128, activation='relu')(x)
x =  layers.Dropout(0.5)(x)

#We Project onnt to a single unti output layers and squash with a sigmoid
